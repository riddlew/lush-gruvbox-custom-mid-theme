...
local M = lush(function(injected_functions)
  ...
  return {
    ...
    GruvboxRedSign         { fg = theme.dark.red, bg = theme.dark.bg1 },
    GruvboxGreenSign       { fg = theme.dark.green, bg = theme.dark.bg1 },
    GruvboxYellowSign      { fg = theme.dark.yellow, bg = theme.dark.bg1 },
    GruvboxBlueSign        { fg = theme.dark.blue, bg = theme.dark.bg1 },
    GruvboxPurpleSign      { fg = theme.dark.purple, bg = theme.dark.bg1 },
    GruvboxAquaSign        { fg = theme.dark.aqua, bg = theme.dark.bg1 },
    GruvboxOrangeSign      { fg = theme.dark.orange, bg = theme.dark.bg1 },
    ...
    NormalNC               { Normal },
    CursorLine             { bg = theme.dark.bg1 },
    CursorColumn           { CursorLine },
    TabLineFill            { fg = theme.dark.bg4, bg = theme.dark.bg1 },
    TabLineSel             { fg = theme.dark.green, bg = theme.dark.bg1 },
    TabLine                { TabLineFill },
    MatchParen             { bg = theme.dark.bg3, gui = "bold" },
    ColorColumn            { bg = theme.dark.bg1 },
    Conceal                { fg = theme.dark.blue },
    CursorLineNr           { fg = theme.dark.yellow, bg = theme.dark.bg1 },
    NonText                { GruvboxBg2 },
    SpecialKey             { GruvboxFg4 },
    Visual                 { bg = theme.dark.bg3 },
    VisualNOS              { Visual },
    ...
    StatusLine             { fg = theme.dark.bg2, bg = theme.dark.fg1, gui = "reverse" },
    StatusLineNC           { fg = theme.dark.bg1, bg = theme.dark.fg4, gui = "reverse" },
    WinBar                 { fg = theme.dark.fg4, bg = theme.dark.bg0 },
    WinBarNC               { fg = theme.dark.fg3, bg = theme.dark.bg1 },
    WinSeparator           { fg = theme.dark.bg3, bg = theme.dark.bg0 },
    WildMenu               { fg = theme.dark.blue, bg = theme.dark.bg2, gui = "bold" },
    Directory              { GruvboxBlueBold },
    Title                  { GruvboxGreenBold },
    ErrorMsg               { fg = theme.dark.bg0, bg = theme.dark.red, gui = "bold" },
    ...
    SignColumn             { bg = theme.dark.bg1 },
    Folded                 { fg = theme.dark.gray, bg = theme.dark.bg1 },
    FoldColumn             { fg = theme.dark.gray, bg = theme.dark.bg1 },
    Cursor                 { gui = "reverse" },
    vCursor                { Cursor },
    iCursor                { Cursor },
    lCursor                { Cursor },
    ...
    Error                  { fg = theme.dark.red, bold = config.bold, gui = "reverse" },
    ...
    Pmenu                  { fg = theme.dark.fg1, bg = theme.dark.bg2 },
    PmenuSel               { fg = theme.dark.bg2, bg = theme.dark.blue, gui = "bold" },
    PmenuSbar              { bg = theme.dark.bg2 },
    PmenuThumb             { bg = theme.dark.bg4 },
    DiffDelete             { fg = theme.dark.red, bg = theme.dark.bg0, gui = "reverse" },
    DiffAdd                { fg = theme.dark.green, bg = theme.dark.bg0, gui = "reverse" },
    DiffChange             { fg = theme.dark.aqua, bg = theme.dark.bg0, gui = "reverse" },
    DiffText               { fg = theme.dark.yellow, bg = theme.dark.bg0, gui = "reverse" },
